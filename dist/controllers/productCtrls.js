...
exports.getWelcome = exports.getOneProduct = exports.postProducts = exports.getProducts = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return _productMdls["default"].findById(req.params.id);

          case 3:
            oneProductDB = _context3.sent;
            ...
            return _context3.abrupt("return", res.status(200).json({
              ok: true,
              message: 'Jack Danields',
              oneProductDB: oneProductDB
            }));
